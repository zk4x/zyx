...
fn add_3() -> Result<(), ZyxError> {
    ...
    let datax: [f32; 32] = [
        -3.285, 0.001, 1.780, 5.675, -8.521, -0.456, 1.215, -3.474, -4.128, -7.657, 2.301, -1.456, 0.987, 3.421, -6.789, 1.234,
        -0.567, 4.890, -2.345, 7.654, 0.111, -9.876, 5.432, -1.234, 8.765, -3.210, 6.543, -4.321, 2.109, -5.678, 0.999, -0.001,
    ];
    let datay: [f32; 32] = [
