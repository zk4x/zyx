...
fn main() {
    ...
    let mut hidden_state = Tensor::uniform(&[1, hidden_size], 0., 1.);
    ...
    for i in 0..1000 {
        ...
        let x = Tensor::from_vec(data, &[1, input_size]);
        // Don't forget to call .detach() on your hidden state to get just Tensor without graph
