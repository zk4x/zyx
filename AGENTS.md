...
- **Reconsidering = ask.** The moment "reconsider"/"wait, but"/"on reflection" appears in your thinking about a design, spec, or your own plan, STOP and ask the user immediately — do not keep reasoning through it on your own. Every instance of reconsidering is a question you are deciding not to ask.
